...
class saifa_Theme_Customize {
	...
	public function settings_init(){
		$settings = array();
		return apply_filters( 'saifa_theme_customizer_settings', $settings );
	}
...
add_action( 'after_setup_theme', array( 'saifa_Theme_Customize', 'get_instance' ), 10 );
