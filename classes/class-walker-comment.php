...
class saifa_Walker_Comment extends Walker_Comment {
	...
	public function __construct() {
		...
		echo '<h3 id="comment-title" class="comment-title">' . __( 'Comments', 'saifa' ) . '</h3>';
		...
		<?php
			...
			comment_text();
				...
				<div class="comment-meta comment-meta-data">
					...
					?>">
					<?php comment_date(); ?> at <?php comment_time(); ?></a> <?php edit_comment_link( __( '(Edit)', 'saifa' ) ); ?>
				</div><!-- /.comment-meta -->
